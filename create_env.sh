...
AUTH_BACKEND_URL=https://localhost:3001
BACKEND_URL=https://localhost:3002
PROFILE_URL=https://localhost:3002
STATS_URL=https://localhost:4100
TOURNAMENT_URL=https://localhost:3004
MATCHMAKING_URL=https://localhost:3003
AUTH_URL=https://localhost:3001
GAME_SERVICE_PATH=wss://localhost:4004
EOF
...
USER_SERVICE_URL=https://localhost:3002
...
SERVICE_PORT=4004
TOURNAMENT_URL=https://localhost:3004/match-result
STATS_URL=https://localhost:4100/match-result
MATCHMAKING_URL=https://localhost:3003/match-result
JWT_SECRET=supersecret
USE_VAULT=false
EOF
...
JWT_SECRET=supersecret
USER_PROFILE_SERVICE_URL=https://localhost:3002
GAME_ENGINE_URL=https://localhost:4004
EOF
...
NODE_ENV=development
USER_PROFILE_SERVICE_URL=https://localhost:3002
GAME_ENGINE_SERVICE_URL=https://localhost:4004
STATS_SERVICE_URL=https://localhost:4100
EOF
...
PORT=3002
NODE_ENV=development
AUTH_SERVICE_URL=https://localhost:3001
